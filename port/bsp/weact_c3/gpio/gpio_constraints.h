 ...
 * @brief GPIO Constraints for WeAct ESP32-C3 BSP
 *
...
#ifndef __WEACT_C3_GPIO_CONSTRAINTS_H
 ...
 */
#define WEACT_C3_PWM_MAX_CHANNELS 6
 ...
 */
#define WEACT_C3_PWM_MAX_SIMULTANEOUS_OUTPUTS 6

/**
 * @brief PWM frequency limits (in Hz)
 */
#define WEACT_C3_PWM_MIN_FREQUENCY 1
#define WEACT_C3_PWM_MAX_FREQUENCY 40000000  // 40MHz theoretical max

/**
 * @brief PWM duty cycle resolution limits (in bits)
 */
#define WEACT_C3_PWM_MIN_RESOLUTION 1
#define WEACT_C3_PWM_MAX_RESOLUTION 16
 ...
 */
#define WEACT_C3_INTERRUPT_MAX_SIMULTANEOUS 22  // All 22 GPIO pins

/**
 * @brief Interrupt task stack size (in bytes)
 */
#define WEACT_C3_INTERRUPT_TASK_STACK_SIZE 2048
 ...
 */
#define WEACT_C3_INTERRUPT_TASK_PRIORITY 5

/**
 * @brief GPIO drive strength options
 */
typedef enum {
    WEACT_C3_GPIO_DRIVE_STRENGTH_5MA = 0,   /**< 5mA drive strength */
    WEACT_C3_GPIO_DRIVE_STRENGTH_10MA,      /**< 10mA drive strength */
    WEACT_C3_GPIO_DRIVE_STRENGTH_20MA,      /**< 20mA drive strength */
    WEACT_C3_GPIO_DRIVE_STRENGTH_40MA,      /**< 40mA drive strength (max) */
    WEACT_C3_GPIO_DRIVE_STRENGTH_MAX
} weact_c3_gpio_drive_strength_t;

/**
 * @brief GPIO sleep mode behavior
 */
typedef enum {
    WEACT_C3_GPIO_SLEEP_HOLD = 0,           /**< Hold pin state during sleep */
    WEACT_C3_GPIO_SLEEP_RELEASE,            /**< Release pin during sleep */
    WEACT_C3_GPIO_SLEEP_MAX
} weact_c3_gpio_sleep_mode_t;
 ...
 */
#define WEACT_C3_PIN_CONFLICTS_COUNT (sizeof(weact_c3_pin_conflicts) / sizeof(weact_c3_pin_conflicts[0]))

extern const weact_c3_pin_conflict_t weact_c3_pin_conflicts[];
...
#endif /* __WEACT_C3_GPIO_CONSTRAINTS_H */
