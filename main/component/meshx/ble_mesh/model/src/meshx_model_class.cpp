 ...
 *****************************************************************************************************/
/* Explicit instantiations for legacy SIG models removed — all guarded by CONFIG_ENABLE_* flags
 * which are disabled in the UVP-only build. No instantiations required here. */
