...
MESHX_LIGHT_HSL_CLIENT_MODEL_TEMPLATE_PROTO
meshx_err_t meshXLightHSLClientModel MESHX_LIGHT_HSL_CLIENT_MODEL_TEMPLATE_PARAMS
    :: request_hsl(uint16_t lightness, uint16_t hue, uint16_t saturation, uint8_t tid)
{
    ...
    meshx_ctx_t ctx = {
        ...
        .opcode   = MESHX_MODEL_OP_LIGHT_HSL_SET,
        .src_addr = 0,
        .dst_addr = common_ctx->pub_addr,
        .p_ctx    = nullptr
    };

    meshx_light_hsl_send_params_t sp = {
        .model = &model_ref,
        .ctx   = &ctx,
        .tid   = tid,
        .state = {
...
{
    auto *el_state = static_cast<meshx_light_hsl_model_state_t*>(this->get_parent_element_state());
    auto *el = this->get_parent_element();
