...
typedef enum {
    ...
    MESHX_CTRL_EVT_GET_COMPOSITION = 0x06, /* Get dynamic composition */
    MESHX_CTRL_EVT_SET_CONSOLE_ROUTING = 0x07, /* Set serial multiplex console routing */
    MESHX_CTRL_EVT_GET_ELEMENT_STATE = 0x08, /* Get current element states */
} meshx_ctrl_evt_t;
