...
typedef struct cwww_client_element
{
    ...
    meshx_model_interface_t *onoff_cli_model;                       /**< Pointer to the list of cwww client on/off generic structures */
    meshx_model_interface_t *ctl_cli_model;                         /**< Pointer to the list of cwww client light CTL structures */
