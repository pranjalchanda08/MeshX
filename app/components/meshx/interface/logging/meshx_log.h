...
#define MESHX_LOG(module_id, level, format, ...) meshx_log_printf(module_id, level, __FILE__, __LINE__, format, ##__VA_ARGS__)

#if CONFIG_MESHX_DEFAULT_LOG_LEVEL < MESHX_LOG_NONE
#define MESHX_LOGE(module_id, format, ...) MESHX_LOG(module_id, MESHX_LOG_ERROR, format, ##__VA_ARGS__)
#else
#define MESHX_LOGE(module_id, format, ...)
#endif

#if CONFIG_MESHX_DEFAULT_LOG_LEVEL < MESHX_LOG_ERROR
#define MESHX_LOGW(module_id, format, ...) MESHX_LOG(module_id, MESHX_LOG_WARN, format, ##__VA_ARGS__)
#else
#define MESHX_LOGW(module_id, format, ...)
#endif

#if CONFIG_MESHX_DEFAULT_LOG_LEVEL < MESHX_LOG_WARN
#define MESHX_LOGI(module_id, format, ...) MESHX_LOG(module_id, MESHX_LOG_INFO, format, ##__VA_ARGS__)
#else
#define MESHX_LOGI(module_id, format, ...)
#endif

#if CONFIG_MESHX_DEFAULT_LOG_LEVEL < MESHX_LOG_INFO
#define MESHX_LOGD(module_id, format, ...) MESHX_LOG(module_id, MESHX_LOG_DEBUG, format, ##__VA_ARGS__)
#else
