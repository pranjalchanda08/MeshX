...
parser.add_argument('--root', type=str, default='..', help='Root directory path for MeshX')
...
class CodeGen(CodeGenException):
    def __init__(self,
        ...
        self.genfile_h = "meshx/default/inc/codegen.h"
        self.define_fmt = "\n#define {}{}{}"
        if os.name == 'nt':
    ...
    def create_cmake_list(self):
        ...
        """
        cmake_c_list_str = [f'    "{self.meshx_root}/{x}"' for x in self.c_list]
        cmake_h_list_str = [f'    "{self.meshx_root}/{x}"' for x in self.inc_list]
